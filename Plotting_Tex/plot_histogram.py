...
#                            bin_step=10, height=800, output_file=dir2 + '/hist_comb_new')
#
# plot_histograms_clustering(dir2 + '/clustering_general_par2',
#                            0, ['cluster_algorithm'],
...
#                            bin_step=10, height=0.11, output_file=dir2 + '/hist_algo_all_new', normalize=True)
#
...
#                             'Gaussian', 'DBSCAN', 'BIRCH'],
#                            max_cluster_amount=20, columns=3,
#                            bin_step=10, height=0.11, output_file=dir2 + '/hist_algo_base_gate_new', normalize=True)
...
#                             'base gate cadical', 'base gate runtimes'],
#                            max_cluster_amount=100, columns=3,
#                            bin_step=10, height=0.11, output_file='single_solver/hist_single_solver_all_algos_100_new',
#                            normalize=True)
#
plot_boxplot_clustering('single_solver/single_solver_par2',
                           0, ['selected_data'],
                           [output_merged],
                           ['base', 'gate', 'base gate', 'base kissat', 'gate kissat', 'base gate kissat',
                            'base glucose', 'gate glucose', 'base gate glucose',
