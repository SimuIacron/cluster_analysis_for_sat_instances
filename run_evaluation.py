...
if __name__ == '__main__':
    ...
    run_evaluation_par2_score('general_clustering_6_single_runtimes_standardscaler', 'general_clustering_6_single_runtimes_standardscaler_par2', db, cores)

    export_clusters_sorted_best('general_clustering_6_single_runtimes_standardscaler_par2', 'general_clustering_6_single_runtimes_standardscaler_clusters')
